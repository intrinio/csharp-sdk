...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoBookAsks)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoBookBids)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoBook)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoCurrencies)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoExchanges)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoPairs)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsobvmean)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsrsi)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalssma)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalssr)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalstrix)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalstsi)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsuo)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsvi)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsvpt)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalsvwap)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptopricetechnicalswr)
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoPrices)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptoprices)
...
namespace Example
{
    public class GetCryptoPricesExample
    {
        public static void Main()
        {
            ...
            var cryptoApi = new CryptoApi();
            var timeframe = "d1";  // string | The time interval for the prices. (default to d1)
 ...
 **startDate** | **DateTime?**| Return Crypto Prices on or after this date. | [optional]  &nbsp;
 **startTime** | **string**| Return Crypto Prices at or after this time (24-hour). | [optional]  &nbsp;
 **endDate** | **DateTime?**| Return Crypto Prices on or before this date. | [optional]  &nbsp;
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoSnapshot)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptosnapshot)
...
namespace Example
{
    public class GetCryptoSnapshotExample
    {
        public static void Main()
        {
            ...
            var exchange = "binance";  // string | Return the snapshot for a Crypto Currency on the given Crypto Exchange. (optional) 
...
[//]: # (RETURN_TYPE:Intrinio.SDK.ModelApiResponseCryptoStats)
...
[//]: # (DOCUMENT_LINK:CryptoApi.md#getcryptostats)
...
namespace Example
{
    public class GetCryptoStatsExample
    {
        public static void Main()
        {
            ...
            var cryptoApi = new CryptoApi();
            var exchange = "binance";  // string | Returns stats for Crypto Currencies that trade on the specified Crypto Exchange. (optional) 
