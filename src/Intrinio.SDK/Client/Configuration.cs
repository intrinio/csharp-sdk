...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.6.4";
        ...
        {
            UserAgent = "Swagger-Codegen/5.6.4/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/5.6.4/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.16.4\n";
            report += "    SDK Package Version: 5.6.4\n";
