...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/5.11.0/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/5.11.0/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.21.1\n";
            report += "    SDK Package Version: 5.11.0\n";
