...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "7.5.4";
        ...
        {
            UserAgent = "Swagger-Codegen/7.5.4/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/7.5.4/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.62.1\n";
            report += "    SDK Package Version: 7.5.4\n";
