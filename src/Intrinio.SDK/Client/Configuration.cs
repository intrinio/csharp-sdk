...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/6.21.0/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/6.21.0/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.28.4\n";
            report += "    SDK Package Version: 6.21.0\n";
