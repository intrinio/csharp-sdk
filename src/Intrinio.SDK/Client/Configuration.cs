...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/5.10.0/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/5.10.0/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.20.0\n";
            report += "    SDK Package Version: 5.10.0\n";
