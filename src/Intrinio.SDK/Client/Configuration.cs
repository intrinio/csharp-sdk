...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "7.5.3";
        ...
        {
            UserAgent = "Swagger-Codegen/7.5.3/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/7.5.3/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.61.1\n";
            report += "    SDK Package Version: 7.5.3\n";
