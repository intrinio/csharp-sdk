...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "7.4.8";
        ...
        {
            UserAgent = "Swagger-Codegen/7.4.8/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/7.4.8/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.52.5\n";
            report += "    SDK Package Version: 7.4.8\n";
