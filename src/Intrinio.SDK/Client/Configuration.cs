...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.21.0";
        ...
        {
            UserAgent = "Swagger-Codegen/5.21.0/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/5.21.0/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.28.0\n";
            report += "    SDK Package Version: 5.21.0\n";
