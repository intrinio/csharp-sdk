...
namespace Intrinio.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/5.16.0/csharp";
        ...
        public Configuration(
            ...
            string userAgent = "Swagger-Codegen/5.16.0/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.26.1\n";
            report += "    SDK Package Version: 5.16.0\n";
