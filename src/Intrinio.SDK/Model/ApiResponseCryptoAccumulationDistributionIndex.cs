...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoAccumulationDistributionIndex :  IEquatable<ApiResponseCryptoAccumulationDistributionIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoAccumulationDistributionIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoAccumulationDistributionIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoAccumulationDistributionIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoAccumulationDistributionIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoAccumulationDistributionIndex input)
        {
            if (input == null)
                return false;
