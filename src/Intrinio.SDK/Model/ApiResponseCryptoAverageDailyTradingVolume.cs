...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoAverageDailyTradingVolume :  IEquatable<ApiResponseCryptoAverageDailyTradingVolume>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoAverageDailyTradingVolume {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoAverageDailyTradingVolume);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoAverageDailyTradingVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoAverageDailyTradingVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoAverageDailyTradingVolume input)
        {
            if (input == null)
                return false;
