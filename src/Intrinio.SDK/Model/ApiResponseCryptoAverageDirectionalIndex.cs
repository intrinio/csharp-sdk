...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoAverageDirectionalIndex :  IEquatable<ApiResponseCryptoAverageDirectionalIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoAverageDirectionalIndex" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoAverageDirectionalIndex(List<AverageDirectionalIndexTechnicalValue> Technicals = default(List<AverageDirectionalIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoAverageDirectionalIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoAverageDirectionalIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoAverageDirectionalIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoAverageDirectionalIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoAverageDirectionalIndex input)
        {
            if (input == null)
                return false;
