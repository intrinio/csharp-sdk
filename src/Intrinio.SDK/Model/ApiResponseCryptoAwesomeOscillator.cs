...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoAwesomeOscillator :  IEquatable<ApiResponseCryptoAwesomeOscillator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoAwesomeOscillator" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoAwesomeOscillator(List<AwesomeOscillatorTechnicalValue> Technicals = default(List<AwesomeOscillatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoAwesomeOscillator {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoAwesomeOscillator);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoAwesomeOscillator instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoAwesomeOscillator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoAwesomeOscillator input)
        {
            if (input == null)
                return false;
