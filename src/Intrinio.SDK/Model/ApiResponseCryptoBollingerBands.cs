...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoBollingerBands :  IEquatable<ApiResponseCryptoBollingerBands>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoBollingerBands" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoBollingerBands(List<BollingerBandsTechnicalValue> Technicals = default(List<BollingerBandsTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoBollingerBands);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoBollingerBands instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoBollingerBands to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoBollingerBands input)
        {
            if (input == null)
                return false;
