...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoChaikinMoneyFlow :  IEquatable<ApiResponseCryptoChaikinMoneyFlow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoChaikinMoneyFlow" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoChaikinMoneyFlow(List<ChaikinMoneyFlowTechnicalValue> Technicals = default(List<ChaikinMoneyFlowTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoChaikinMoneyFlow);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoChaikinMoneyFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoChaikinMoneyFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoChaikinMoneyFlow input)
        {
            if (input == null)
                return false;
