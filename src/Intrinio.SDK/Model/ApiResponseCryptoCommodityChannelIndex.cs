...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoCommodityChannelIndex :  IEquatable<ApiResponseCryptoCommodityChannelIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoCommodityChannelIndex" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoCommodityChannelIndex(List<CommodityChannelIndexTechnicalValue> Technicals = default(List<CommodityChannelIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoCommodityChannelIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoCommodityChannelIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoCommodityChannelIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoCommodityChannelIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoCommodityChannelIndex input)
        {
            if (input == null)
                return false;
