...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoDetrendedPriceOscillator :  IEquatable<ApiResponseCryptoDetrendedPriceOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiResponseCryptoDetrendedPriceOscillator);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoDetrendedPriceOscillator instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoDetrendedPriceOscillator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoDetrendedPriceOscillator input)
        {
            if (input == null)
                return false;
