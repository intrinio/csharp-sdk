...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoDonchianChannel :  IEquatable<ApiResponseCryptoDonchianChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoDonchianChannel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoDonchianChannel {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoDonchianChannel);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoDonchianChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoDonchianChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoDonchianChannel input)
        {
            if (input == null)
                return false;
