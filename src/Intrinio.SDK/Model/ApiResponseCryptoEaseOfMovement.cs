...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoEaseOfMovement :  IEquatable<ApiResponseCryptoEaseOfMovement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoEaseOfMovement" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoEaseOfMovement(List<EaseOfMovementTechnicalValue> Technicals = default(List<EaseOfMovementTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoEaseOfMovement);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoEaseOfMovement instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoEaseOfMovement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoEaseOfMovement input)
        {
            if (input == null)
                return false;
