...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoForceIndex :  IEquatable<ApiResponseCryptoForceIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoForceIndex" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoForceIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoForceIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoForceIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoForceIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoForceIndex input)
        {
            if (input == null)
                return false;
