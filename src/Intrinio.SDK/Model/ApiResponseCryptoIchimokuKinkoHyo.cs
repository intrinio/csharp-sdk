...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoIchimokuKinkoHyo :  IEquatable<ApiResponseCryptoIchimokuKinkoHyo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoIchimokuKinkoHyo" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoIchimokuKinkoHyo(List<IchimokuKinkoHyoTechnicalValue> Technicals = default(List<IchimokuKinkoHyoTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoIchimokuKinkoHyo {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoIchimokuKinkoHyo);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoIchimokuKinkoHyo instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoIchimokuKinkoHyo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoIchimokuKinkoHyo input)
        {
            if (input == null)
                return false;
