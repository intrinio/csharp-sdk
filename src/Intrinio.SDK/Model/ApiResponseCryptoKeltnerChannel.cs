...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoKeltnerChannel :  IEquatable<ApiResponseCryptoKeltnerChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoKeltnerChannel" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoKeltnerChannel(List<KeltnerChannelTechnicalValue> Technicals = default(List<KeltnerChannelTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoKeltnerChannel {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoKeltnerChannel);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoKeltnerChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoKeltnerChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoKeltnerChannel input)
        {
            if (input == null)
                return false;
