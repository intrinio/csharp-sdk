...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoKnowSureThing :  IEquatable<ApiResponseCryptoKnowSureThing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoKnowSureThing" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoKnowSureThing(List<KnowSureThingTechnicalValue> Technicals = default(List<KnowSureThingTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoKnowSureThing {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoKnowSureThing);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoKnowSureThing instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoKnowSureThing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoKnowSureThing input)
        {
            if (input == null)
                return false;
