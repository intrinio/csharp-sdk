...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoMassIndex :  IEquatable<ApiResponseCryptoMassIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoMassIndex" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoMassIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoMassIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoMassIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoMassIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoMassIndex input)
        {
            if (input == null)
                return false;
