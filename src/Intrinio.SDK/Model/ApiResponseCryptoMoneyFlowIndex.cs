...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoMoneyFlowIndex :  IEquatable<ApiResponseCryptoMoneyFlowIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoMoneyFlowIndex" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoMoneyFlowIndex(List<MoneyFlowIndexTechnicalValue> Technicals = default(List<MoneyFlowIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoMoneyFlowIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoMoneyFlowIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoMoneyFlowIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoMoneyFlowIndex input)
        {
            if (input == null)
                return false;
