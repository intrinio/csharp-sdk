...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoMovingAverageConvergenceDivergence :  IEquatable<ApiResponseCryptoMovingAverageConvergenceDivergence>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiResponseCryptoMovingAverageConvergenceDivergence);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoMovingAverageConvergenceDivergence instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoMovingAverageConvergenceDivergence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoMovingAverageConvergenceDivergence input)
        {
            if (input == null)
                return false;
