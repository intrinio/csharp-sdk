...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoNegativeVolumeIndex :  IEquatable<ApiResponseCryptoNegativeVolumeIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoNegativeVolumeIndex" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoNegativeVolumeIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoNegativeVolumeIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoNegativeVolumeIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoNegativeVolumeIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoNegativeVolumeIndex input)
        {
            if (input == null)
                return false;
