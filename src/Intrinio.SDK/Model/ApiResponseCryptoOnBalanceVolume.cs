...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoOnBalanceVolume :  IEquatable<ApiResponseCryptoOnBalanceVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoOnBalanceVolume" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoOnBalanceVolume(List<OnBalanceVolumeTechnicalValue> Technicals = default(List<OnBalanceVolumeTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoOnBalanceVolume {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoOnBalanceVolume);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoOnBalanceVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoOnBalanceVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoOnBalanceVolume input)
        {
            if (input == null)
                return false;
