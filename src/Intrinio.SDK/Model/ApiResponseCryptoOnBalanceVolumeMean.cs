...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoOnBalanceVolumeMean :  IEquatable<ApiResponseCryptoOnBalanceVolumeMean>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoOnBalanceVolumeMean" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoOnBalanceVolumeMean(List<OnBalanceVolumeMeanTechnicalValue> Technicals = default(List<OnBalanceVolumeMeanTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoOnBalanceVolumeMean);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoOnBalanceVolumeMean instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoOnBalanceVolumeMean to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoOnBalanceVolumeMean input)
        {
            if (input == null)
                return false;
