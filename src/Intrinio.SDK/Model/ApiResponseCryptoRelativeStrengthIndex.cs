...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoRelativeStrengthIndex :  IEquatable<ApiResponseCryptoRelativeStrengthIndex>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiResponseCryptoRelativeStrengthIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoRelativeStrengthIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoRelativeStrengthIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoRelativeStrengthIndex input)
        {
            if (input == null)
                return false;
