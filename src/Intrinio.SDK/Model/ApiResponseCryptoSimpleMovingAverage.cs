...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoSimpleMovingAverage :  IEquatable<ApiResponseCryptoSimpleMovingAverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoSimpleMovingAverage" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoSimpleMovingAverage {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoSimpleMovingAverage);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoSimpleMovingAverage instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoSimpleMovingAverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoSimpleMovingAverage input)
        {
            if (input == null)
                return false;
