...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoStochasticOscillator :  IEquatable<ApiResponseCryptoStochasticOscillator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoStochasticOscillator" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoStochasticOscillator(List<StochasticOscillatorTechnicalValue> Technicals = default(List<StochasticOscillatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoStochasticOscillator {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoStochasticOscillator);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoStochasticOscillator instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoStochasticOscillator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoStochasticOscillator input)
        {
            if (input == null)
                return false;
