...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoTripleExponentialAverage :  IEquatable<ApiResponseCryptoTripleExponentialAverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoTripleExponentialAverage" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoTripleExponentialAverage(List<TripleExponentialAverageTechnicalValue> Technicals = default(List<TripleExponentialAverageTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoTripleExponentialAverage);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoTripleExponentialAverage instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoTripleExponentialAverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoTripleExponentialAverage input)
        {
            if (input == null)
                return false;
