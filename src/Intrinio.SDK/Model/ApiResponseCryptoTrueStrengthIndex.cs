...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoTrueStrengthIndex :  IEquatable<ApiResponseCryptoTrueStrengthIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoTrueStrengthIndex" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoTrueStrengthIndex {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoTrueStrengthIndex);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoTrueStrengthIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoTrueStrengthIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoTrueStrengthIndex input)
        {
            if (input == null)
                return false;
