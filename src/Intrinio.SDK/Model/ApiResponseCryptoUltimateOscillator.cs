...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoUltimateOscillator :  IEquatable<ApiResponseCryptoUltimateOscillator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoUltimateOscillator" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoUltimateOscillator(List<UltimateOscillatorTechnicalValue> Technicals = default(List<UltimateOscillatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoUltimateOscillator {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoUltimateOscillator);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoUltimateOscillator instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoUltimateOscillator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoUltimateOscillator input)
        {
            if (input == null)
                return false;
