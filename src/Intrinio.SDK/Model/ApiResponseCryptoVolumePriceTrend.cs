...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoVolumePriceTrend :  IEquatable<ApiResponseCryptoVolumePriceTrend>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoVolumePriceTrend" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoVolumePriceTrend(List<VolumePriceTrendTechnicalValue> Technicals = default(List<VolumePriceTrendTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseCryptoVolumePriceTrend);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoVolumePriceTrend instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoVolumePriceTrend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoVolumePriceTrend input)
        {
            if (input == null)
                return false;
