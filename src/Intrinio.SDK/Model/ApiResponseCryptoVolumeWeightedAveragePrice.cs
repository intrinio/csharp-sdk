...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoVolumeWeightedAveragePrice :  IEquatable<ApiResponseCryptoVolumeWeightedAveragePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoVolumeWeightedAveragePrice" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApiResponseCryptoVolumeWeightedAveragePrice);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoVolumeWeightedAveragePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoVolumeWeightedAveragePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoVolumeWeightedAveragePrice input)
        {
            if (input == null)
                return false;
