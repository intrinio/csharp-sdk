...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoVortexIndicator :  IEquatable<ApiResponseCryptoVortexIndicator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseCryptoVortexIndicator" /> class.
        /// </summary>
        ...
        public ApiResponseCryptoVortexIndicator(List<VortexIndicatorTechnicalValue> Technicals = default(List<VortexIndicatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), CryptoPairSummary Pair = default(CryptoPairSummary), CryptoExchangeSummary Exchange = default(CryptoExchangeSummary), string Timeframe = default(string), string NextPage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoVortexIndicator {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoVortexIndicator);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoVortexIndicator instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoVortexIndicator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoVortexIndicator input)
        {
            if (input == null)
                return false;
