...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseCryptoWilliamsR :  IEquatable<ApiResponseCryptoWilliamsR>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseCryptoWilliamsR {\n");
        ...
        {
            return this.Equals(input as ApiResponseCryptoWilliamsR);
        }

        /// <summary>
        /// Returns true if ApiResponseCryptoWilliamsR instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseCryptoWilliamsR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseCryptoWilliamsR input)
        {
            if (input == null)
                return false;
