...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseFilingAnswers :  IEquatable<ApiResponseFilingAnswers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseFilingAnswers" /> class.
        /// </summary>
        ...
        public ApiResponseFilingAnswers(string Source = default(string), string Query = default(string), List<TheaEntityAnswer> Answers = default(List<TheaEntityAnswer>), List<Filing> Companies = default(List<Filing>))
        {
            this.Source = Source;
            this.Query = Query;
        ...
        public List<Filing> Companies { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseFilingAnswers);
        }

        /// <summary>
        /// Returns true if ApiResponseFilingAnswers instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseFilingAnswers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseFilingAnswers input)
        {
            if (input == null)
                return false;
