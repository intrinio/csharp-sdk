...
namespace Intrinio.SDK.Model
{
    ...
    public partial class ApiResponseIndexConstituents :  IEquatable<ApiResponseIndexConstituents>, IValidatableObject
    {
        ...
        public ApiResponseIndexConstituents(ApiResponseIndex Index = default(ApiResponseIndex), DateTime? Date = default(DateTime?), IndexConstituents Constituents = default(IndexConstituents))
        {
            this.Index = Index;
            this.Date = Date;
        ...
        public IndexConstituents Constituents { get; set; }
        ...
        public bool Equals(ApiResponseIndexConstituents input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.Constituents.Equals(input.Constituents))
                );
        }
