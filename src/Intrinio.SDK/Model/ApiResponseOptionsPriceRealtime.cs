...
namespace Intrinio.SDK.Model
{
    ...
    public partial class ApiResponseOptionsPriceRealtime :  IEquatable<ApiResponseOptionsPriceRealtime>, IValidatableObject
    {
        ...
        public ApiResponseOptionsPriceRealtime(OptionPriceRealtime Price = default(OptionPriceRealtime), OptionStatsRealtime Stats = default(OptionStatsRealtime), OptionRealtime Option = default(OptionRealtime), OptionPriceRealtimeExtended ExtendedPrice = default(OptionPriceRealtimeExtended))
        {
            this.Price = Price;
            this.Stats = Stats;
            this.Option = Option;
        ...
        {
            return this.Equals(input as ApiResponseOptionsPriceRealtime);
        }
