...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityAverageDirectionalIndex :  IEquatable<ApiResponseSecurityAverageDirectionalIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAverageDirectionalIndex(List<AverageDirectionalIndexTechnicalValue> Technicals = default(List<AverageDirectionalIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityAverageDirectionalIndex);
        }
