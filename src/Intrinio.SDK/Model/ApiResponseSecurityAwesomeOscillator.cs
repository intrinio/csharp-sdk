...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityAwesomeOscillator :  IEquatable<ApiResponseSecurityAwesomeOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityAwesomeOscillator(List<AwesomeOscillatorTechnicalValue> Technicals = default(List<AwesomeOscillatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityAwesomeOscillator);
        }
