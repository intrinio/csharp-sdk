...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityKeltnerChannel :  IEquatable<ApiResponseSecurityKeltnerChannel>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityKeltnerChannel(List<KeltnerChannelTechnicalValue> Technicals = default(List<KeltnerChannelTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityKeltnerChannel);
        }
