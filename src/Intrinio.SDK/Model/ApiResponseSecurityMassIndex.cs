...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityMassIndex :  IEquatable<ApiResponseSecurityMassIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityMassIndex(List<MassIndexTechnicalValue> Technicals = default(List<MassIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityMassIndex);
        }
