...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityMoneyFlowIndex :  IEquatable<ApiResponseSecurityMoneyFlowIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityMoneyFlowIndex(List<MoneyFlowIndexTechnicalValue> Technicals = default(List<MoneyFlowIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityMoneyFlowIndex);
        }
