...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityOnBalanceVolume :  IEquatable<ApiResponseSecurityOnBalanceVolume>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityOnBalanceVolume(List<OnBalanceVolumeTechnicalValue> Technicals = default(List<OnBalanceVolumeTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityOnBalanceVolume);
        }
