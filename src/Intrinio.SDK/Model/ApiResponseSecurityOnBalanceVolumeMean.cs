...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityOnBalanceVolumeMean :  IEquatable<ApiResponseSecurityOnBalanceVolumeMean>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiResponseSecurityOnBalanceVolumeMean);
        }
