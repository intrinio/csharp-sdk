...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecuritySimpleMovingAverage :  IEquatable<ApiResponseSecuritySimpleMovingAverage>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecuritySimpleMovingAverage(List<SimpleMovingAverageTechnicalValue> Technicals = default(List<SimpleMovingAverageTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecuritySimpleMovingAverage);
        }
