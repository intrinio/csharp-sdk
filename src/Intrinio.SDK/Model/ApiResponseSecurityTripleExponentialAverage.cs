...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityTripleExponentialAverage :  IEquatable<ApiResponseSecurityTripleExponentialAverage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiResponseSecurityTripleExponentialAverage);
        }
