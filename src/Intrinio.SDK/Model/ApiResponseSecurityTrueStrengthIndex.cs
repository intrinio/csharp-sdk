...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityTrueStrengthIndex :  IEquatable<ApiResponseSecurityTrueStrengthIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityTrueStrengthIndex(List<TrueStrengthIndexTechnicalValue> Technicals = default(List<TrueStrengthIndexTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityTrueStrengthIndex);
        }
