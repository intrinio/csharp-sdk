...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityUltimateOscillator :  IEquatable<ApiResponseSecurityUltimateOscillator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityUltimateOscillator(List<UltimateOscillatorTechnicalValue> Technicals = default(List<UltimateOscillatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityUltimateOscillator);
        }
