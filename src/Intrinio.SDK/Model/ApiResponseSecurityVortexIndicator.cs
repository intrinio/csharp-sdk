...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseSecurityVortexIndicator :  IEquatable<ApiResponseSecurityVortexIndicator>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseSecurityVortexIndicator(List<VortexIndicatorTechnicalValue> Technicals = default(List<VortexIndicatorTechnicalValue>), TechnicalIndicator Indicator = default(TechnicalIndicator), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseSecurityVortexIndicator);
        }
