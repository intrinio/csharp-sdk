...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ESGComprehensiveRatingWithCompany :  IEquatable<ESGComprehensiveRatingWithCompany>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ESGComprehensiveRatingWithCompany" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ESGComprehensiveRatingWithCompany {\n");
        ...
        {
            return this.Equals(input as ESGComprehensiveRatingWithCompany);
        }

        /// <summary>
        /// Returns true if ESGComprehensiveRatingWithCompany instances are equal
        /// </summary>
        /// <param name="input">Instance of ESGComprehensiveRatingWithCompany to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ESGComprehensiveRatingWithCompany input)
        {
            if (input == null)
                return false;
