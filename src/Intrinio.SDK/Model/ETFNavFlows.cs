...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ETFNavFlows :  IEquatable<ETFNavFlows>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ETFNavFlows" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ETFNavFlows);
        }

        /// <summary>
        /// Returns true if ETFNavFlows instances are equal
        /// </summary>
        /// <param name="input">Instance of ETFNavFlows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ETFNavFlows input)
        {
            if (input == null)
                return false;
