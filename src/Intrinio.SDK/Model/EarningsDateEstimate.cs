...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EarningsDateEstimate :  IEquatable<EarningsDateEstimate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningsDateEstimate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EarningsDateEstimate);
        }

        /// <summary>
        /// Returns true if EarningsDateEstimate instances are equal
        /// </summary>
        /// <param name="input">Instance of EarningsDateEstimate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EarningsDateEstimate input)
        {
            if (input == null)
                return false;
