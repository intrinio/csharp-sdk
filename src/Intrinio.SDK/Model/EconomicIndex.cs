...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EconomicIndex :  IEquatable<EconomicIndex>, IValidatableObject
    {
        /// <summary>
        ...
        public EconomicIndex(string Id = default(string), string Symbol = default(string), string Name = default(string), string Continent = default(string), string Country = default(string), string UpdateFrequency = default(string), DateTime? LastUpdated = default(DateTime?), string Description = default(string), DateTime? ObservationStart = default(DateTime?), DateTime? ObservationEnd = default(DateTime?), string SeasonalAdjustment = default(string), string Units = default(string))
        {
            this.Id = Id;
            this.Symbol = Symbol;
            this.Name = Name;
        ...
        {
            return this.Equals(input as EconomicIndex);
        }
