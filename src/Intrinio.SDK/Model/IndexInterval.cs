...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IndexInterval :  IEquatable<IndexInterval>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexInterval" /> class.
        /// </summary>
        ...
        public IndexInterval(DateTime? Time = default(DateTime?), decimal? Open = default(decimal?), decimal? Close = default(decimal?), decimal? High = default(decimal?), decimal? Low = default(decimal?), DateTime? CloseTime = default(DateTime?), IntervalEnum? Interval = default(IntervalEnum?), decimal? Average = default(decimal?), decimal? Change = default(decimal?))
        {
            this.Time = Time;
            this.Open = Open;
            this.Close = Close;
        ...
        {
            return this.Equals(input as IndexInterval);
        }

        /// <summary>
        /// Returns true if IndexInterval instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexInterval input)
        {
            if (input == null)
                return false;
