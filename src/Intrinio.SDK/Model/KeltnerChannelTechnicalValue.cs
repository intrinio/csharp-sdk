...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeltnerChannelTechnicalValue :  IEquatable<KeltnerChannelTechnicalValue>, IValidatableObject
    {
        /// <summary>
        ...
        public KeltnerChannelTechnicalValue(DateTime? DateTime = default(DateTime?), float? LowerBand = default(float?), float? MiddleBand = default(float?), float? UpperBand = default(float?))
        {
        ...
        {
            return this.Equals(input as KeltnerChannelTechnicalValue);
        }
