...
namespace Intrinio.SDK.Model
{
    ...
    public partial class OptionChainRealtime :  IEquatable<OptionChainRealtime>, IValidatableObject
    {
        ...
        public OptionChainRealtime(OptionRealtime Option = default(OptionRealtime), OptionPriceRealtime Price = default(OptionPriceRealtime))
        {
            this.Option = Option;
            this.Price = Price;
        }
        ...
        {
            return this.Equals(input as OptionChainRealtime);
        }
