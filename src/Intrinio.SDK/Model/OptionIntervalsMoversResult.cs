...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptionIntervalsMoversResult :  IEquatable<OptionIntervalsMoversResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionIntervalsMoversResult" /> class.
        /// </summary>
        ...
        public OptionIntervalsMoversResult(DateTime? OpenTime = default(DateTime?), DateTime? CloseTime = default(DateTime?), SizeEnum? Size = default(SizeEnum?), List<OptionIntervalMover> Intervals = default(List<OptionIntervalMover>))
        {
        ...
        public List<OptionIntervalMover> Intervals { get; set; }
        ...
        {
            return this.Equals(input as OptionIntervalsMoversResult);
        }

        /// <summary>
        /// Returns true if OptionIntervalsMoversResult instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionIntervalsMoversResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionIntervalsMoversResult input)
        {
            if (input == null)
                return false;
