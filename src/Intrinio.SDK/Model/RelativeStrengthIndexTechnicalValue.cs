...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelativeStrengthIndexTechnicalValue :  IEquatable<RelativeStrengthIndexTechnicalValue>, IValidatableObject
    {
        /// <summary>
        ...
        public RelativeStrengthIndexTechnicalValue(DateTime? DateTime = default(DateTime?), float? Rsi = default(float?))
        {
        ...
        {
            return this.Equals(input as RelativeStrengthIndexTechnicalValue);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Rsi != null)
                    hashCode = hashCode * 59 + this.Rsi.GetHashCode();
                return hashCode;
            }
        }
