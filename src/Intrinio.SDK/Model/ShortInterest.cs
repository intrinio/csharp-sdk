...
namespace Intrinio.SDK.Model
{
    ...
    public partial class ShortInterest :  IEquatable<ShortInterest>, IValidatableObject
    {
        ...
        public ShortInterest(DateTime? SettlementDate = default(DateTime?), int? CurrentShortPosition = default(int?), int? PreviousShortPosition = default(int?), float? ChangePercent = default(float?), float? DaysToCover = default(float?), int? AverageDailyVolume = default(int?))
        {
