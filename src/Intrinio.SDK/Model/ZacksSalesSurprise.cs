...
namespace Intrinio.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ZacksSalesSurprise :  IEquatable<ZacksSalesSurprise>, IValidatableObject
    {
        /// <summary>
        ...
        public ZacksSalesSurprise(string Id = default(string), decimal? FiscalYear = default(decimal?), string FiscalQuarter = default(string), decimal? CalendarYear = default(decimal?), string CalendarQuarter = default(string), DateTime? ActualReportedDate = default(DateTime?), string ActualReportedTime = default(string), string ActualReportedCode = default(string), string ActualReportedDesc = default(string), DateTime? LastRevDate = default(DateTime?), decimal? SalesActual = default(decimal?), decimal? SalesActualZacksAdj = default(decimal?), decimal? SalesActualGaap = default(decimal?), decimal? SalesMeanEstimate = default(decimal?), decimal? SalesAmountDiff = default(decimal?), decimal? SalesPercentDiff = default(decimal?), decimal? SalesStdDevEstimate = default(decimal?))
        {
            this.Id = Id;
