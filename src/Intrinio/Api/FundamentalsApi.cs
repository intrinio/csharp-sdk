...
namespace Intrinio.Api
{
    ...
    public interface IFundamentalsApi : IApiAccessor
    {
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>List&lt;ReportedFinancial&gt;</returns>
        List<ReportedFinancial> GetFundamentalReportedFinancials (string id);
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>ApiResponse of List&lt;ReportedFinancial&gt;</returns>
        ApiResponse<List<ReportedFinancial>> GetFundamentalReportedFinancialsWithHttpInfo (string id);
        /// <summary>
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>List&lt;StandardizedFinancial&gt;</returns>
        List<StandardizedFinancial> GetFundamentalStandardizedFinancials (string id);
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>ApiResponse of List&lt;StandardizedFinancial&gt;</returns>
        ApiResponse<List<StandardizedFinancial>> GetFundamentalStandardizedFinancialsWithHttpInfo (string id);
        /// <summary>
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of List&lt;ReportedFinancial&gt;</returns>
        System.Threading.Tasks.Task<List<ReportedFinancial>> GetFundamentalReportedFinancialsAsync (string id);
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of ApiResponse (List&lt;ReportedFinancial&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ReportedFinancial>>> GetFundamentalReportedFinancialsAsyncWithHttpInfo (string id);
        /// <summary>
        /// Get Standardized Financials for a Fundamental
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of List&lt;StandardizedFinancial&gt;</returns>
        System.Threading.Tasks.Task<List<StandardizedFinancial>> GetFundamentalStandardizedFinancialsAsync (string id);
        ...
        /// <exception cref="Intrinio.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of ApiResponse (List&lt;StandardizedFinancial&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<StandardizedFinancial>>> GetFundamentalStandardizedFinancialsAsyncWithHttpInfo (string id);
        /// <summary>
        /// Lookup a Fundamental
        /// </summary>
        /// <remarks>
    ...
    public partial class FundamentalsApi : IFundamentalsApi
    {
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>List&lt;ReportedFinancial&gt;</returns>
        public List<ReportedFinancial> GetFundamentalReportedFinancials (string id)
        {
             ApiResponse<List<ReportedFinancial>> localVarResponse = GetFundamentalReportedFinancialsWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>ApiResponse of List&lt;ReportedFinancial&gt;</returns>
        public ApiResponse< List<ReportedFinancial> > GetFundamentalReportedFinancialsWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<List<ReportedFinancial>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ReportedFinancial>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ReportedFinancial>)));
        }
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of List&lt;ReportedFinancial&gt;</returns>
        public async System.Threading.Tasks.Task<List<ReportedFinancial>> GetFundamentalReportedFinancialsAsync (string id)
        {
             ApiResponse<List<ReportedFinancial>> localVarResponse = await GetFundamentalReportedFinancialsAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of ApiResponse (List&lt;ReportedFinancial&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ReportedFinancial>>> GetFundamentalReportedFinancialsAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling FundamentalsApi->GetFundamentalReportedFinancials");
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>List&lt;StandardizedFinancial&gt;</returns>
        public List<StandardizedFinancial> GetFundamentalStandardizedFinancials (string id)
        {
             ApiResponse<List<StandardizedFinancial>> localVarResponse = GetFundamentalStandardizedFinancialsWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>ApiResponse of List&lt;StandardizedFinancial&gt;</returns>
        public ApiResponse< List<StandardizedFinancial> > GetFundamentalStandardizedFinancialsWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<List<StandardizedFinancial>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<StandardizedFinancial>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<StandardizedFinancial>)));
        }
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of List&lt;StandardizedFinancial&gt;</returns>
        public async System.Threading.Tasks.Task<List<StandardizedFinancial>> GetFundamentalStandardizedFinancialsAsync (string id)
        {
             ApiResponse<List<StandardizedFinancial>> localVarResponse = await GetFundamentalStandardizedFinancialsAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The Intrinio ID for the Fundamental</param>
        /// <returns>Task of ApiResponse (List&lt;StandardizedFinancial&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<StandardizedFinancial>>> GetFundamentalStandardizedFinancialsAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling FundamentalsApi->GetFundamentalStandardizedFinancials");
