...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>, IValidatableObject
    {
        ...
        public InlineResponse20016(List<HistoricalData> HistoricalData = default(List<HistoricalData>), EconomicIndexSummary Index = default(EconomicIndexSummary), string NextPage = default(string))
        {
