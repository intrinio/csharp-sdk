...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>, IValidatableObject
    {
        ...
        public InlineResponse20019(List<HistoricalData> HistoricalData = default(List<HistoricalData>), SICIndex Index = default(SICIndex), string NextPage = default(string))
        {
