...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>, IValidatableObject
    {
        ...
        public InlineResponse20022(List<HistoricalData> HistoricalData = default(List<HistoricalData>), StockMarketIndexSummary Index = default(StockMarketIndexSummary), string NextPage = default(string))
        {
