...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(List<HistoricalData> HistoricalData = default(List<HistoricalData>), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
