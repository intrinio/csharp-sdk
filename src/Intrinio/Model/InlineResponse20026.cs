...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20026 :  IEquatable<InlineResponse20026>, IValidatableObject
    {
        ...
        public InlineResponse20026(List<StockPriceSummary> StockPrices = default(List<StockPriceSummary>), SecuritySummary Security = default(SecuritySummary), string NextPage = default(string))
        {
