...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>, IValidatableObject
    {
        ...
        public InlineResponse20029(List<StockPrice> StockPrices = default(List<StockPrice>), StockExchange StockExchange = default(StockExchange), string NextPage = default(string))
        {
