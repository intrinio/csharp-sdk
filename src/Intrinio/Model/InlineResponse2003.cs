...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<FilingSummary> Filings = default(List<FilingSummary>), CompanySummary Company = default(CompanySummary), string NextPage = default(string))
        {
