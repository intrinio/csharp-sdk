...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse20031 :  IEquatable<InlineResponse20031>, IValidatableObject
    {
        ...
        public InlineResponse20031(List<SecuritySummary> Securities = default(List<SecuritySummary>), StockExchange StockExchange = default(StockExchange), string NextPage = default(string))
        {
