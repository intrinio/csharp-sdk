...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(List<FundamentalSummary> Fundamentals = default(List<FundamentalSummary>), CompanySummary Company = default(CompanySummary), string NextPage = default(string))
        {
