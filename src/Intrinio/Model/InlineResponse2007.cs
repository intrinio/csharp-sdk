...
namespace Intrinio.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(List<SecuritySummary> News = default(List<SecuritySummary>), CompanySummary Company = default(CompanySummary), string NextPage = default(string))
        {
            this.News = News;
        ...
        public List<SecuritySummary> News { get; set; }
