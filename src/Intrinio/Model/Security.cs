...
namespace Intrinio.Model
{
    ...
    public partial class Security :  IEquatable<Security>, IValidatableObject
    {
        ...
        /// <param name="Isin">The International Securities Identification Number.</param>
        /// <param name="Cusip">An identifier provided by the Committee on Uniform Security Identification Procedures (U.S.).</param>
        /// <param name="Sedol">An identifier provided by the Stock Exchange Daily Official List (U.K.).</param>
        ...
        public Security(string Id = default(string), string CompanyId = default(string), string Name = default(string), string Type = default(string), string Code = default(string), string ShareClass = default(string), string Currency = default(string), decimal? RoundLotSize = default(decimal?), string Ticker = default(string), string ExchangeTicker = default(string), string CompositeTicker = default(string), List<string> AlternateTickers = default(List<string>), string Figi = default(string), string CompositeFigi = default(string), string ShareClassFigi = default(string), string FigiUniqueid = default(string), string Isin = default(string), string Cusip = default(string), string Sedol = default(string), bool? Active = default(bool?), bool? Etf = default(bool?), bool? Delisted = default(bool?), bool? PrimaryListing = default(bool?), bool? PrimarySecurity = default(bool?), DateTime? FirstStockPrice = default(DateTime?), DateTime? LastStockPrice = default(DateTime?), DateTime? LastStockPriceAdjustment = default(DateTime?), DateTime? LastCorporateAction = default(DateTime?))
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>An identifier provided by the Committee on Uniform Security Identification Procedures (U.S.)</value>
        ...
        /// </summary>
        /// <value>An identifier provided by the Stock Exchange Daily Official List (U.K.)</value>
